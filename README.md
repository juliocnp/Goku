### 1 Especicação do Problema
Son Goku é um poderoso Saiyajin (raça de poderosos guerreiros). Ele está na busca pelas 7 esferas do
dragão1
com o objetivo de ressuscitar seu amigo Kuririn que foi morto por Freeza.
Goku já reuniu 6 das 7 esperas. Ele descobriu que a última esfera do dragão está em uma caverna
escondida nos conns da selva. Até hoje nenhum guerreiro conseguiu recuperar a esfera, pois ela é bem
...
um monstro, Goku gasta uma certa quantidade de Ki (o custo da magia) e ininge um certo dano ao monstro.
O dano inigido provoca a perda de pontos de vida do monstro (o número de pontos perdidos depende da
...
um conjunto de salões conectados por galerias. Os salões são identicados sequencialmente de 1 a N. Goku
sempre inicia no salão 1 e a esfera do dragão está sempre no salão N. Existem K monstros identicados
...
inicial de Ki necessária para que Goku consiga recuperar a esfera do dragão.
1São bolas laranjas e cristalinas que podem invocar o Deus Dragão Shenlong que tem a habilidade de conceder desejos para
...
O nal da entrada é indicado por M = N = G = K = 0.
